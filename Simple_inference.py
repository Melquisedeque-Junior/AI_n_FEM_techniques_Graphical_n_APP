...
#If not, the model is saved on disk.
if os.path.isfile('models/medical_trial_model.h5') is False:
    model.save('models/medical_trial_model.h5')

#For importing the saved model for other aplication
#from tensorflow.keras.models import load_model
#new_model = load_model('models/medical_trial_model.h5')

#Commands for checking the imported model
#model.summary()
...
#Check model architecture w/o weights and trained parameters
...
#import os.path
#if os.path.isfile('models/my_model_weghts.h5') is False:
#   model.save_weights('models/my_model_weights.h5')

#Load saved weights on a new model:
#model2 = Sequential([
#   Dense(units=16, input_shape=(1,), activation='relu'),
#   Dense(units=32, activation='relu'),
#   Dense(units=2, activation='softmax')
